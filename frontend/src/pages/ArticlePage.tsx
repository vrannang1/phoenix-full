...
const ArticlePage = () => {
  ...
  // const slug: string | undefined = location.state?.slug;

  console.log('slug is ', state);

  // Check if slug is null or undefined and handle it early
  if (!state) {
    return (
      <div style={{ textAlign: 'center' }}>
        <h1 className="logo-font">Article not found</h1>
      </div>
    );
  }
            ...
            <Container maxWidth="lg">
              <Grid container alignItems="center" spacing={2} marginBottom={3}>
                <img
                  height={360}
                  width="100%"
                  src={articleInfo.data.source === 'annrapid' ? articleInfo.data.coverImage : articleInfo.data.imageUrl}

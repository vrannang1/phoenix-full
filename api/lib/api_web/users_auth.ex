defmodule ApiWeb.UsersAuth do
  ...
  the current_users:
      ...
      defmodule ApiWeb.PageLive do
        use ApiWeb, :live_view

        on_mount {ApiWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ApiWeb.UsersAuth, :ensure_authenticated}] do
